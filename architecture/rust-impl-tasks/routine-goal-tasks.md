...
- [x] **定义 RoutineVariable 与 EnvConfig 类型**
...
- [x] **实现 Database Schema 迁移 - Routine 相关表**
...
- [x] **实现 Database Schema 迁移 - RoutineRun 与 Approval 表**
...
- [x] **实现 Database Schema 迁移 - Goal 表**
...
- [x] **定义 RoutineTriggerRepository trait**
...
- [x] **实现 RoutineTriggerRepository 基础操作**
...
- [x] **实现 RoutineTriggerRepository 更新与删除**
...
- [x] **定义 RoutineRunRepository trait**
...
- [x] **实现 Goal 与 Routine/Issue 的关联查询**
...
- [x] **定义 Activity 核心类型与 Repository trait**
...
- [x] **定义 DashboardRepository trait**
...
- [x] **实现 Activity 与 Dashboard 路由完整逻辑**
