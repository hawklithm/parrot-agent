...
- [ ] **实现 Database Schema 迁移 - Pipeline 相关表**
...
- [ ] **实现 Database Schema 迁移 - Case 相关表**
...
- [ ] **实现 Repository trait - Case / Stage / Transition**
...
- [ ] **实现 ACP (Agent Communication Protocol) 适配**
