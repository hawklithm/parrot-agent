...
- [x] **定义 company_memberships 表 schema**
...
- [x] **定义 project_workspaces 表 schema**
...
- [x] **定义 resource_memberships 表 schema**
...
- [x] **实现 ResourceMembershipRepository**
...
- [x] **实现 ResourceMembershipService 查询**
...
- [x] **实现 ResourceMembershipService 更新**
...
- [x] **实现 CompanySkillService 基础 CRUD**
...
- [x] **实现 CloudUpstreamService 连接初始化**
...
- [x] **Resource Membership API 集成测试**
