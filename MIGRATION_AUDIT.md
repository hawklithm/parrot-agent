...
- migrations: **95**
- CREATE TABLE: **130**（含 IF NOT EXISTS: **70**）
- 无 company_id 的业务表（候选待核）: **23**
- 有 company_id 但无索引: **50**
...
| `heartbeat_runs` (20260712000002_create_heartbeat_runs.sql) |
| `execution_workspaces` (20260712000007_create_execution_workspaces.sql) |
| `environment_leases` (20260712000008_create_environment_leases.sql) |
| `company_secret_provider_configs` (20260712000010_create_company_secret_provider_configs.sql) |
| `user_secret_definitions` (20260712000014_create_user_secret_definitions.sql) |
| `user_secret_declarations` (20260712000015_create_user_secret_declarations.sql) |
...
| `issue_relations` (20260805000004_create_issue_relations.sql) |
| `issue_plan_decompositions` (20260808000006_create_issue_plan_decompositions.sql) |
| `heartbeat_run_watchdog_decisions` (20260813000001_create_heartbeat_run_watchdog_decisions.sql) |
| `decision_bundles` (20260813000002_create_decisions.sql) |
...
| `decision_queues` (20260813000003_create_decision_queues.sql) |
...
| `decision_training_examples` (20260813000004_create_decision_training_examples.sql) |
